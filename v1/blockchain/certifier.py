...
class APIAuth():
    ...
    def _sign(
            ...
            generate_nonce=None, iat=None, algorithm=''):
        """
        Create a signed JWT using the given access_key_id and RSA private key.

        Input Params:
            access_key_id(str): access_key_id (string) to authenticate as on the
                remote system.
        ...
        if not generate_nonce:
            def generate_nonce(access_key_id, iat): return random.random()  # NOQA
        token_data = {
