...
class TransferTokenRequest(BlockchainRequest):
    ...
    def prepare_header(self, private=None, public=None):
        """ When doing a transaction, the header is signed using the senders key and private """
...
class AbstractTokenTransaction(models.Model):
    ...
    @property
    def token_id(self):
        """ To be implemented in the subclass to return the asset code of item to be transacted """
        raise NotImplementedError()
